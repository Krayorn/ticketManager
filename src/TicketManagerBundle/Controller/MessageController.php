...
class MessageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $messages = $em->getRepository('TicketManagerBundle:Message')->findAll();

        return $this->render('TicketManagerBundle::message/index.html.twig', array(
            'messages' => $messages,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('TicketManagerBundle::message/new.html.twig', array(
            'message' => $message,
    ...
    public function showAction(Message $message)
    {
        ...
        return $this->render('TicketManagerBundle::message/show.html.twig', array(
            'message' => $message,
